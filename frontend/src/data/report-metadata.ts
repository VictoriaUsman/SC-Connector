...
export const SP_REPORT_METADATA: Record<string, SpReportMeta> = {
  ...
  GET_FBA_INVENTORY_PLANNING_DATA: {
    description: "Consolidated inventory health: sales velocity, storage fees, aging, and restock recommendations",
    format: "tsv",
    columns: [
      ...
      "currency", "units-shipped-t7", "units-shipped-t30",
      "units-shipped-t60", "units-shipped-t90",
      "alert", "your-price", "sales-price",
      "lowest-price-new-plus-shipping", "lowest-price-used",
      "recommended-action", "recommended-sales-price",
      "recommended-sale-duration-days", "recommended-removal-quantity",
      "estimated-cost-savings-of-recommended-actions",
      "sell-through", "item-volume", "volume-unit-measurement",
      "storage-type", "storage-volume", "marketplace",
      "product-group", "sales-rank", "days-of-supply",
      ...
      "Recommended ship-in quantity", "Recommended ship-in date",
    ],
  },
